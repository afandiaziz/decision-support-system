...
$data = getData($connection, 'question', $_GET['id']);

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (updateData($connection, 'question', $_GET['id'], [
        'question' => $_POST['name'],
        ...
        <div class="card-body">
            <form action="" method="post" id="form" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control required" value="<?= $data['question'] ?>">
