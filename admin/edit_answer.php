...
$data = getData($connection, 'answer', $_GET['id']);

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (updateData($connection, 'answer', $_GET['id'], [
        'answer' => $_POST['name'],
        ...
        <div class="card-body">
            <form action="" method="post" id="form" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <select name="id_question" class="form-control required" id="id_question">
                        ...
                        <?php foreach ($question as $item) : ?>
                            <option <?= ($data['id_question'] == $item['id'] ? 'selected' : '') ?> value="<?= $item['id'] ?>"><?= $item['question'] ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control required" value="<?= $data['answer'] ?>">
                    <div class="small text-danger d-none">Tidak Boleh Kosong</div>
                </div>
                <div class="form-group">
